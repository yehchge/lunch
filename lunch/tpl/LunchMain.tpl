...
<body topmargin="0" leftmargin="0" bgcolor="#EAEBEF">
  <table height="51" bgcolor="#cccccc" width="100%">
    <tr>
      <td valign="center">
	    <table border=0>
	      <tr>
		    <td><font size=4 face="標楷體" color="#000000"><b>&nbsp;&nbsp;&nbsp;DinBenDon系統</b></font></td>
	      </tr>
	    </table>  
	  </td>
    </tr>
  ...
  <div id="navBar">
    <div id="sectionLinks"><li><a href='./index.php?func=store&action=add'>新增店家</a></li></div><!-- AddStore.php -->
    <div id="sectionLinks"><li><a href='./index.php?func=store&action=list'>店家維護</a></li></div><!-- ./ListStore.php -->
	<div id="sectionLinks"><li><a href='./AssignStore.php'>指定店家old</a></li></div><!-- ./AssignStore.php -->
	...
	<div id="sectionLinks"><li><a href='./OrderStore.php'>DinBenDon(今日)</a></li></div>
  ...
  <div id="siteInfo">
    <div align="center"><span class="style10">版權所有 &copy; DinBenDon股份有限公司</span></div>
  </div> 
</body>
</html>