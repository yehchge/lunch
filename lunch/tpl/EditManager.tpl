...
<center>
<form name="frm" method="post" onsubmit="return check_form(frm);" action="/lunch/EditManagered.php">
...
<table Class="Forums_General" Width="70%">
  ...
  <tr>
    <td colspan=2 align="right"> [ <input type="image" src="tpl/images/OK.gif" name="sb1"> 確定 ]&nbsp;[ <a href="/lunch/ListAssignStore.php"><img src="tpl/images/Cancel.gif" border=0></a> 取消 ] </td>
  </tr>
</table>
</form>
</center>
