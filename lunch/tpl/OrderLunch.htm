      ...
      <tr>
        <td>
          <table style="font-size:12px" cellspacing="2" border="0" cellpadding="2" width="100%">
            ...
            <tr>
              <td colspan="9" align="right"> [ <input type="image" src="tpl/images/OK.gif" name="sb"> 確定訂購 ]&nbsp;[ <a href="./index.php?func=manager&action=list"><img src="tpl/images/Cancel.gif" border=0></a> 取消 ] </td>
            </tr>
          </table>
        </td>
      </tr>
